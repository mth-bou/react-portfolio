...
const TailwindCssIcon = (props: ComponentPropsWithoutRef<"svg"> & {size?: number}) => {
    return (
        <svg width={props.size} height={props.size} viewBox="0 0 256 154" version="1.1" xmlns="http://www.w3.org/2000/svg"
