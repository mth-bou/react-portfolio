...
const NextJsIcon = (props: ComponentPropsWithoutRef<"svg"> & {size?: number}) => {
    return (
        <svg width={props.size} height={props.size} viewBox="0 0 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg"
            ...
            <defs>
                ...
                <linearGradient x1="55.6325605%" y1="56.3850422%" x2="83.2279093%" y2="96.0801119%"
            ...
            <g>
                ...
                <g mask="url(#mask-2)">
                    ...
                    <rect fill="url(#nextjsLinearGradient-4)" x="163.555556" y="76.8" width="17.0666667"
                          height="102.4"></rect>
                </g>
            </g>
        </svg>
