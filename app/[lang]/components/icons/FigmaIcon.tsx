...
const FigmaIcon = (props: ComponentPropsWithoutRef<"svg"> & {size?: number}) => {
    return (
        <svg width={props.size} height={props.size} viewBox="0 0 256 384" version="1.1" xmlns="http://www.w3.org/2000/svg"
